...
public class Artista {
    ...
    public String getColorFila() {
        String colorfila="";
        if (idinstrumento.equals("VOC")) {
            colorfila= "fila-yellow";
        } else if (idinstrumento.equals("GUI")) {
            colorfila= "fila-red";
        } else if (idinstrumento.equals("BSS")) {
            colorfila= "fila-purple";
        } else if (idinstrumento.equals("DRM")) {
            colorfila= "fila-blue";
        }
        return colorfila;
    }
